      ...
      return {
        ...
        link: function (scope, ele, attrs) {
            ...
            console.log(scope.selectedHood);
               scope.$watch('selectedHood', function(newValue, oldValue) {
                if (newValue)
                    console.log("I see a data change!");

              d3.csv("http://data.sfgov.org/resource/g383-7xmf.csv?planning_neighborhood=" + scope.selectedHood + "&$select=units,best_stat", function (error, data) {
